...
function Models() {
  // Group by task so the entries can be filtered instead of read as one
...
function PartnersAndFaq() {
  const faqs = [
    ...
    ['What is the model roadmap?', 'The public catalog currently spans language generation, vision-language, speech recognition, text-to-speech, and audio-to-audio models. For roadmap details, follow the organization\u2019s Hugging Face activity and public repositories.'],
  ]
...
function App() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'What is the SapinSapin AI model roadmap?', acceptedAnswer: { '@type': 'Answer', text: 'The public catalog currently spans language generation, vision-language, speech recognition, text-to-speech, and audio-to-audio models. For roadmap details, follow the organization\'s Hugging Face activity and public repositories.' } },
    ],
  }
